import { HeartIcon, HomeIcon, LinkIcon, UserGroupIcon } from "@heroicons/react/24/solid";

const features = [
  {
    name: 'Dining and Housing Info.',
    description: 'View dining menus and accurate dining hall capacities in real time. Swipe for meals and ASUCLA restaurants digitally. View laundry machine availabilities and bathroom cleaning times.',
    icon: HomeIcon,
  },
  {
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-center lg:gap-y-0">
          <div className="lg:max-w-md">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              A central hub for everyday UCLA resources, including dining, housing, clubs, and more.
            </p>
            <dl className="max-w-xl space-y-8 text-base leading-7 text-gray-300 lg:max-w-none lg:border-t lg:border-white/10 lg:pt-5 lg:mt-5">
              {features.map((f) => (
          ...
          {/* <img
            ...
            height={1442}
          /> */}
          <div className="lg:max-w-md flex justify-center">
            <img
              src="/home-frame.png"
              alt="Product screenshot"
              className="relative -z-20 rounded-xl shadow-xl ring-white/10 lg:max-w-none"
              width={300}
              height={200}
            />
          </div>
