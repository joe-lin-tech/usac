...
const socials = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/joelinforusac/",
    icon: (props: any) => (
  ...
  // {
  //   name: 'GitHub',
  //   href: 'https://github.com/joe-lin-tech',
  //   icon: (props: any) => (
  //     <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
  //       <path
  //         fillRule="evenodd"
    ...
    <footer className="bg-[#FFBD59] text-black">
      <div className="mx-auto max-w-7xl overflow-hidden py-10 px-6 sm:py-12 lg:px-8">
        <nav className="-mb-6 columns-2 sm:flex sm:justify-center sm:space-x-12 text-center" aria-label="Footer">
          {links.map((l) => (
            <div key={l.name} className="pb-6">
              <a href={l.href} className="text-sm leading-6">
                {l.name}
              </a>
            </div>
          ))}
        ...
        <p className="mt-5 text-center text-xs leading-5">
          2023-24 Joe Lin for USAC. Made with Next.js and Tailwind.
        </p>
